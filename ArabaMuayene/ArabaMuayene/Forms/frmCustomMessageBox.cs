...
namespace ArabaMuayene.Forms
{
    public partial class frmCustomMessageBox : Form
    {
        ...
        public void Initialize(string message, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            ...
            MessageCaptionLbl.Text = InsertLineBreaks(message);
        ...
        private void SetIcon(MessageBoxIcon icon) {
            switch (icon)
            {
                ...
                case MessageBoxIcon.Warning:
                    IconPbx.Image = SystemIcons.Warning.ToBitmap();
                    break;
                case MessageBoxIcon.Error:
                    IconPbx.Image = SystemIcons.Error.ToBitmap();
                    break;
                case MessageBoxIcon.Question:
                    IconPbx.Image = SystemIcons.Question.ToBitmap();
                    break;
